...
function validpassword(password){
  ...
  if (password != "") {
    var passwordfor = /^(?=.*\d)(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z]).{8,}$/;
      ...
      {
      document.getElementById("password").innerHTML="Password should  be > 8 letters, with at least a symbol, upper and lower case letters and a number "
      return false;
      }
  }
  else{
  ...
  <body>
    <div class="row">
      ...
      <div class="col-sm-4 text-center  mt-3">
        <form name="form" action="Register" onsubmit="return validateForm()" method="post">
        <img class="m-auto" src="lock.gif" alt="" width="25px">
        <h5>Sign Up</h5>
        <div class="d-grid gap-4 mt-5">
        <input  onkeyup="validname(this.value)"  class="form-control text-center" type="text" name="name" id="" placeholder="Name" required >
        ...
        <input class="form-control text-center"onfocus="(this.type='date')" onblur="(this.type='text')" type="text" name="date" id="" placeholder="DOB" required>
        <label id="date" ></label>
